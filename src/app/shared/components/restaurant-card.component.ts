      ...
      <div class="flex items-center justify-between text-sm text-gray-600 border-t pt-3">
        ...
        <div class="flex items-center gap-1">
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 13.586V6a1 1 0 012 0v7.586l3.293-3.293a1 1 0 111.414 1.414l-4 4z" clip-rule="evenodd" />
          </svg>
...
export class RestaurantCardComponent {
  ...
  onSelect(): void {
    ...
    const restaurantId = this.restaurant._id || this.restaurant.id;
    this.router.navigate(['/catalog', restaurantId]);
  }
}
